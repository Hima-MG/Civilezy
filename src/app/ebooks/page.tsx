...
export const metadata: Metadata = {
  ...
  description:
    "Kerala PSC Civil Engineering Quick Revision E-Books. Syllabus-based, concise revision guides for Overseer GR.1, Instructor, AE Civil and more. Browse our marketplace.",
  openGraph: {
    title: "E-Books – Quick Revision Guides | CivilEzy",
    description:

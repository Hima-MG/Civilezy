...
export const metadata: Metadata = {
  title: "How to Crack Kerala PSC Civil Engineering Exam – Complete Guide",
  description:
    "Step-by-step strategy to crack the Kerala PSC Civil Engineering exam. Covers syllabus, study plan, best resources, mock test approach, and rank-scoring tips for ITI, Diploma, B.Tech & AE categories.",
  keywords: [
    "how to crack kerala psc civil engineering",
    "kerala psc civil engineering exam strategy",
    "kerala psc civil syllabus",
    "psc civil engineering study plan kerala",
    "kerala psc ae civil preparation",
  ],
  alternates: { canonical: "https://civilezy.in/blog/how-to-crack-kerala-psc-civil-engineering" },
  openGraph: {
    type: "article",
    locale: "en_IN",
    url: "https://civilezy.in/blog/how-to-crack-kerala-psc-civil-engineering",
    siteName: "CivilEzy",
    title: "How to Crack Kerala PSC Civil Engineering Exam – Complete Guide",
    description:
      "Complete roadmap to crack Kerala PSC Civil Engineering. Syllabus breakdown, study plan, practice strategy, and insider tips from Wincentre experts.",
  },
};
...
const schemaArticle = {
  ...
  "@type": "Article",
  headline: "How to Crack Kerala PSC Civil Engineering Exam – Complete Guide",
  description:
    "Step-by-step strategy to crack the Kerala PSC Civil Engineering exam for ITI, Diploma, B.Tech and AE categories.",
  ...
  mainEntityOfPage: "https://civilezy.in/blog/how-to-crack-kerala-psc-civil-engineering",
};

const SECTIONS = [
  {
    heading: "Understanding the Kerala PSC Civil Engineering Exam Structure",
    content: [
  ...
  {
    heading: "Kerala PSC Civil Engineering Syllabus – Subject-Wise Breakdown",
    content: [
  ...
  {
    heading: "Building Your Kerala PSC Civil Engineering Study Plan",
    content: [
  ...
  {
    heading: "How to Use CivilEzy Game Arena for PSC Preparation",
    content: [
  ...
  {
    heading: "Handling Negative Marking – The Smart Strategy",
    content: [
  ...
  {
    heading: "General Knowledge Preparation for Kerala PSC Civil Exam",
    content: [
  ...
  {
    heading: "Common Mistakes Kerala PSC Civil Aspirants Make",
    content: [
  ...
  {
    heading: "The Wincentre Advantage – Why 1000+ Candidates Got Government Jobs",
    content: [
  ...
  {
    heading: "Final Checklist Before Your Kerala PSC Civil Engineering Exam",
    content: [
      ...
      "Start your preparation today on CivilEzy's Game Arena – Kerala's best PSC civil engineering practice platform, powered by Wincentre.",
    ],
  },
];
      ...
      <main style={{ background: "var(--navy)", color: "#fff", minHeight: "100vh", padding: "0 0 80px" }}>
        ...
        <div style={{ background: "linear-gradient(160deg, #040C18 0%, #0B1E3D 100%)", padding: "70px 5% 56px" }}>
          <div style={{ maxWidth: "820px", margin: "0 auto" }}>
            ...
            <nav aria-label="Breadcrumb" style={{ marginBottom: "24px", fontSize: "13px", color: "rgba(255,255,255,0.45)", display: "flex", gap: "8px", alignItems: "center", flexWrap: "wrap" }}>
              ...
              <span aria-hidden="true">/</span>
              <span style={{ color: "#FF8534" }}>How to Crack Kerala PSC Civil</span>
            </nav>
            ...
            <h1 style={{ fontFamily: "Rajdhani, sans-serif", fontSize: "clamp(1.9rem, 4.5vw, 3rem)", fontWeight: 700, lineHeight: 1.18, color: "#fff", marginBottom: "20px" }}>
              How to Crack Kerala PSC Civil Engineering Exam – Complete Guide
            </h1>
        ...
        <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "60px 5% 0" }} className="article-layout">
          ...
          <article style={{ maxWidth: "760px" }}>
            {SECTIONS.map((sec) => (
              <section key={sec.heading} style={{ marginBottom: "52px" }}>
                <h2 style={{ fontFamily: "Rajdhani, sans-serif", fontSize: "clamp(1.3rem, 2.5vw, 1.7rem)", fontWeight: 700, color: "#fff", marginBottom: "20px", paddingBottom: "12px", borderBottom: "1px solid rgba(255,255,255,0.08)" }}>
                  {sec.heading}
                </h2>
                {sec.content.map((para, i) => (
                  <p key={i} style={{ fontSize: "1rem", color: "rgba(255,255,255,0.72)", lineHeight: 1.85, marginBottom: "16px" }}>
                    {para}
                  </p>
                ))}
              </section>
            ...
            {/* CTA inside article */}
            <div style={{ background: "linear-gradient(135deg, rgba(255,98,0,0.12), rgba(255,98,0,0.06))", border: "1px solid rgba(255,98,0,0.25)", borderRadius: "18px", padding: "36px 32px", marginBottom: "52px", textAlign: "center" }}>
              <h3 style={{ fontFamily: "Rajdhani, sans-serif", fontSize: "1.5rem", fontWeight: 700, color: "#fff", marginBottom: "12px" }}>
                Start Practicing on CivilEzy Game Arena
              </h3>
              <p style={{ color: "rgba(255,255,255,0.65)", fontSize: "0.95rem", marginBottom: "24px", lineHeight: 1.7 }}>
                Kerala&apos;s first gamified PSC mock test platform. Free to use. Compete on the weekly leaderboard.
              </p>
              <Link
                href="/game-arena"
                style={{ display: "inline-block", background: "linear-gradient(135deg, #FF6200, #FF8534)", color: "#fff", padding: "14px 34px", borderRadius: "10px", fontWeight: 700, fontSize: "1rem", textDecoration: "none", fontFamily: "Rajdhani, sans-serif" }}
              >
          ...
          {/* Sidebar */}
          <aside aria-label="Quick links and CTA" style={{ position: "sticky", top: "100px", alignSelf: "flex-start" }}>
            <div style={{ background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.08)", borderRadius: "18px", padding: "28px 24px", marginBottom: "24px" }}>
              <h3 style={{ fontFamily: "Rajdhani, sans-serif", fontSize: "1.1rem", fontWeight: 700, color: "#fff", marginBottom: "18px" }}>In This Article</h3>
              <ul style={{ listStyle: "none", padding: 0, margin: 0, display: "flex", flexDirection: "column", gap: "12px" }}>
                {SECTIONS.map((s, i) => (
                  <li key={i} style={{ fontSize: "13px", color: "rgba(255,255,255,0.6)", lineHeight: 1.5, paddingLeft: "12px", borderLeft: "2px solid rgba(255,98,0,0.3)" }}>
                    {s.heading}
                  </li>
                ))}
              </ul>
            ...
            <div style={{ background: "linear-gradient(135deg, #FF6200, #CC3D00)", borderRadius: "18px", padding: "28px 24px", textAlign: "center" }}>
              <div style={{ fontSize: "2rem", marginBottom: "10px" }}>🎮</div>
              <h3 style={{ fontFamily: "Rajdhani, sans-serif", fontSize: "1.15rem", fontWeight: 700, color: "#fff", marginBottom: "10px" }}>Practice on Game Arena</h3>
              <p style={{ fontSize: "0.87rem", color: "rgba(255,255,255,0.85)", lineHeight: 1.65, marginBottom: "20px" }}>Free mock tests. Live leaderboard. Real PSC questions.</p>
            ...
            <div style={{ background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.08)", borderRadius: "18px", padding: "24px", marginTop: "24px" }}>
              <h3 style={{ fontFamily: "Rajdhani, sans-serif", fontSize: "1rem", fontWeight: 700, color: "#fff", marginBottom: "14px" }}>Course Plans</h3>
              <p style={{ fontSize: "13px", color: "rgba(255,255,255,0.55)", marginBottom: "16px", lineHeight: 1.65 }}>ITI · Diploma · B.Tech · Surveyor</p>
